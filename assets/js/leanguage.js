...
function engLeanguage() {
  ...
  linkcv.innerHTML = '<i class="bi bi-award"></i> Proses Panen';
  linkcv.setAttribute("href", "https://www.youtube.com/channel/UCpN6rb4e0gb_8h5O4OT6xkg");
  ...
  about1.innerHTML = "My name is Rizal Ahmad Fauzan, 24 years old. I started to enter the world of ornamental fish since I graduated from SMK.";
  about2.innerHTML = "I have 4+ years of experience cultivating ornamental fish in both ground and tarpaulin ponds.";
  ...
  viewYt.forEach((element) => {
    element.innerHTML = '<i class="bi bi-youtube" ></i> Check it out on YouTube';
  });
...
function idLeanguage() {
  ...
  about1.innerHTML = "Nama saya Rizal Ahmad Fauzan berusia 24 tahun. Saya mulai terjun ke dunia ikan hias sejak lulus SMK.";
  about2.innerHTML = "Saya memiliki pengalaman 4+ tahun budidaya ikan hias di kolam tanah maupun kolam terpal.";
  ...
  viewYt.forEach((element) => {
    element.innerHTML = '<i class="bi bi-youtube" ></i> Lihat di YouTube';
  });
  viewGithub.forEach((element) => {
    element.innerHTML = '<i class="bi bi-whatsapp"></i> Pesan Sekarang';
  });
  viewMore.forEach((element) => {
